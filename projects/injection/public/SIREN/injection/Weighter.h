...
public:
    ...
    void DebugBreakdown(std::tuple<siren::math::Vector3D, siren::math::Vector3D> const & bounds, siren::dataclasses::InteractionTreeDatum const & datum, std::ostream & os) const;
